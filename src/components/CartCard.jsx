...
function CartCard({...FoodInfo}) {
    const data = FoodInfo?.card?.info
    console.log(data)
  return (
  ...
  <div
    ...
    <img
      src={Restaurant_Img_Url+data?.imageId}
  ...
  <div className="p-6">
    ...
    <p className="block font-sans text-base font-bold antialiased leading-relaxed text-gray-700">
    ...
    <div className="inline-flex flex-wrap items-center gap-3 mt-8 group">
      <h1 className='font-bold text-xl text-green-500'>₹ {data?.price/100}</h1>
    </div>
  </div>
